...
export class ListUserComponent implements OnInit, OnDestroy {
  ...
  async onViewEdit(user: User, isEditMode: boolean = false) {
    const { UserDetailModalModule } = await import('../user-detail-modal/user-detail-modal.module');
    this.store.dispatch(showDialog({
      component: UserDetailModalModule.getComponent(),
      config: {
